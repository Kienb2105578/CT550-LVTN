                ...
                <form action="{{ route('my-order.index') }}" method="post" class="form-order">
                    ...
                    <div id="order-tabs" class="order-section">
                        <ul class="nav nav-tabs">
                            <li class="nav-item">
                                <a class="nav-link order-tab active" data-confirm="" data-payment="" data-delivery=""
                                    data-status="all">
                                    Tất cả
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link order-tab" data-confirm="pending" data-payment="" data-delivery="">
                                    Chờ Xác Nhận
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link order-tab" data-confirm="confirm" data-payment=""
                                    data-delivery="pending">
                                    Đã Xác Nhận
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link order-tab" data-confirm="confirm" data-payment="paid"
                            ...
                            <li class="nav-item">
                                <a class="nav-link order-tab" data-confirm="cancle" data-payment="" data-delivery="">
                                    Đã Hủy
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link order-tab" data-payment="refunded" data-delivery="returned">
                                    Trả Hàng
                                </a>
                            </li>
                        </ul>
