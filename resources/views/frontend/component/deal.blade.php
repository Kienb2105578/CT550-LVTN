<div class="deal-item product">
    <div class="badge">
        <span>Top <br> Deals</span>
    </div>
    <div class="uk-grid uk-grid-medium">
        <div class="uk-width-large-2-5">
            <div class="thumb">
                <a href="" class="image img-scaledown"><img src="resources/img/deal-<?php echo rand(1, 2); ?>.png"
                        alt=""></a>
                <div class="countdown uk-flex uk-flex-center" data-countdown="2023-07-04 15:04:00">
        ...
        <div class="uk-width-large-3-5">
            <div class="info">
                ...
                <div class="title"><a href="" title="">2022 Apple iMac with Retina 5K Display 8GB RAM,
                        256GB SSD</a></div>
                <div class="rating">
                    <div class="uk-flex uk-flex-middle">
                        <div class="star">
