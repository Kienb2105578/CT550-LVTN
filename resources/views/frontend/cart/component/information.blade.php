        ...
        <div class="cart-information">
                ...
                <div class="uk-width-large-1-2">
                    <div class="form-row">
                        <input type="text" name="fullname"
                            value="{{ old('fullname', auth()->guard('customer')->user()->name) }}"
            ...
            <div class="form-row mb20">
                <input type="text" name="email"
                    value="{{ old('email', auth()->guard('customer')->user()->email) }}" placeholder="Nhập vào Email"
                    class="input-text">
            </div>
            <div class="form-row mb20">
                <input type="text" name="address"
                    value="{{ old('address', auth()->guard('customer')->user()->address) }}"
                    placeholder="Nhập vào địa chỉ: ví dụ đường Lạc Long Quân..." class="input-text">
            </div>
            <div class="uk-grid uk-grid-medium mb20">
                <div class="uk-width-large-1-3">
                    <select name="province_id" id="" class="form-control province location setupSelect2"
            ...
            <div class="form-row">
                <input type="text" name="description" value="{{ old('description') }}"
                    placeholder="Ghi chú thêm (Ví dụ: Giao hàng vào lúc 3 giờ chiều)" class="input-text">
            </div>
        </div>
    @else
        <div class="cart-information">
            ...
            <div class="form-row mb20">
                <input type="text" name="email" value="{{ old('email') }}" placeholder="Nhập vào Email"
                    class="input-text">
            </div>
            <div class="form-row mb20">
