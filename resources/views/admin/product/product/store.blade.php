...
<form action="{{ $url }}" method="post" class="box">
    ...
    <div class="wrapper wrapper-content animated fadeInRight">
        <div class="row">
            <div class="col-lg-9">
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                        @include('admin.dashboard.component.content', ['model' => $product ?? null])
                    </div>
                </div>
                @include('admin.dashboard.component.album', ['model' => $product ?? null])
                @include('admin.product.product.component.variant')
                <div class="ibox">
                    <div class="ibox-title">
            ...
            <div class="col-lg-3">
                @include('admin.product.product.component.aside')
            </div>
        </div>
