...
@php
    $url =
        $config['method'] == 'create'
            ...
            : route('product.catalogue.update', [$productCatalogue->id, $queryUrl ?? '']);
@endphp
<form action="{{ $url }}" method="post" class="box">
    ...
    <div class="wrapper wrapper-content animated fadeInRight">
        <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-row">
                                        ...
                                        <input type="text" name="name"
                                            ...
                                            data-flag = "{{ isset($productCatalogue->name) ? 1 : 0 }}" placeholder=""
                            ...
                            <div class="col-lg-12">
                                <div class="form-row">
                                    ...
                                    <textarea name="description" class="ck-editor" id="ckDescription" {{ isset($disabled) ? 'disabled' : '' }}
                                        data-height="100">{{ old('description', $productCatalogue->description ?? '') }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="input-wrapper">
                                        <input type="text" name="canonical"
                                            value="{{ old('canonical', $productCatalogue->canonical ?? '') }}"
            ...
            <div class="col-lg-3">
                @include('admin.product.catalogue.component.aside')
            </div>
        </div>
