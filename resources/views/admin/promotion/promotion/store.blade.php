...
<form action="{{ $url }}" method="post" class="box">
    ...
    <div class="wrapper wrapper-content animated fadeInRight promotion-wrapper">
        <div class="row">
            <div class="col-lg-8">
                @include('admin.promotion.component.general', ['model' => $promotion ?? null])
                @include('admin.promotion.promotion.component.detail')
            </div>
            @include('admin.promotion.component.aside', ['model' => $promotion ?? null])
        </div>
...
@include('admin.promotion.promotion.component.popup')
...
<input type="hidden" class="input_order_amount_range"
    value="{{ json_encode(old('order_amount_range', $promotion->discountInformation['info'] ?? null)) }}">
