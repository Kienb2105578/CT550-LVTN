                            ...
                            <div class="panel-body">
                                ...
                                <div class="panel-description">
                                    ...
                                    <a style="color:#000;border-color:#c4cdd5;display:inline-block !important;"
                                        href="" title=""
                                        class="btn btn-default add-menu m-b m-r right">Thêm đường dẫn</a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#{{ $key }}"
                                        class="collapsed menu-module" data-model="{{ $key }}"
                                        aria-expanded="false">{{ $val }}</a>
                                </h4>
                            </div>
                            ...
                            <div class="row mb10 menu-item menu-item uk-flex uk-flex-middle">
                                ...
                                <div class="col-lg-2">
                                    <div class="form-row text-center">
                                        <a class="delete-menu" data-menu-id="{{ (int) $menu['id'][$key] }}"><img
