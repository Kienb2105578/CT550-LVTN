...
class OrderController extends Controller
{
    ...
    public function exportPdf($id)
    {
        ...
        $config['seo'] = __('messages.order');
        $template = 'admin.orders.invoice';

        $pdf = PDF::loadView('admin.order.invoice', compact(
            'order',
            'provinces',
            'template',
            'config'
    ...
    public function exportMultiplePdf(Request $request)
    {
        ...
        $template = 'admin.orders.multiple_invoices';

        $pdf = PDF::loadView('admin.order.multiple_invoices', compact(
            'orders',
            'provinces',
            'template',
            'config'
