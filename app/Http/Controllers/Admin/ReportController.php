...
class ReportController extends Controller
{
    ...
    public function exportFileProduct(Request $request)
    {
        ...
        $config = $this->config();
        $template = 'admin.report.exportFileProduct';
        $pdf = PDF::loadView('admin.report.exportFileProduct', compact(
            'reports',
            'template',
            'config'
        ));
    ...
    public function exportFileTime(Request $request)
    {
        ...
        $config = $this->config();
        $template = 'admin.report.exportFileTime';
        $pdf = PDF::loadView('admin.report.exportFileTime', compact(
            'reports',
            'template',
            'config'
        ));
